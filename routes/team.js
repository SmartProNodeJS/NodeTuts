...
route.get('/:id',  function (req, res) {
    ...
    if(idCheck.test(id)) {
      players.find({"_id":id}, {}, function(err, teams){
        var sportcb = function(err, sport_list){
           res.render('teams',{"btn_caption":"Update", "page_title":"Edit Teams","sport_list":sport_list,"team":teams[0],"menu_items":menu_items});
           res.end();
        }
       if(err){
      ...
      var newteam = {"_id":new ObjectID(),"team_name":"","team_number":"","sport_name":""}
...
route.post('/',urlencodedParser,  function (req, res) {
  console.log("Request.body = "+JSON.stringify(req.body));
    ...
    team.team_number = req.body.team_number;
