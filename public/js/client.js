...
kendo.ui.ListView.prototype.clear = (function() {
  function clear(textToDisplay) {
    this.setDataSource(new kendo.data.DataSource({ data: [] }));
    this.wrapper.append('<div style="color: #888; padding: 10px">' + textToDisplay + '</div>');
  }
